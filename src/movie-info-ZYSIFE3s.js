...
`,M=class M extends v{render(){return c`
    ...
    `}};M.styles=[R,U];let w=M;customElements.get("person-loading-skeleton")||customElements.define("person-loading-skeleton",w);var _=Object.defineProperty,f=(e,t,o,i)=>{for(var s=void 0,r=e.length-1,a;r>=0;r--)(a=e[r])&&(s=a(t,o,s)||s);return s&&_(t,o,s),s};const $=class $ extends v{constructor(){super(...arguments),this.name="",this.role="",this.image="",this.loading=!1}render(){return c`${this.loading?c`<person-loading-skeleton></person-loading-skeleton>`:c` <div class="person-bubble">
          <img
            loading="lazy"
            src="${this.image||E}"
            alt="${this.name}"
      ...
      <div class="container">
        <div class="main-info">
          <div class="header">
            ...
            <div class="metadata">
              <p>
                Runtime: ${z(this.selectedMovie.runtime)}
              </p>
          ...
          <div class="links">
            <a
              target="_blank"
              href="${B((i=(o=this.selectedMovie)==null?void 0:o.ids)==null?void 0:i.slug)}"
              >${Z.TraktSvg}</a
            >
            <a
              target="_blank"
            ...
            <a
              target="_blank"
              href="${I((b=(a=this.selectedMovie)==null?void 0:a.ids)==null?void 0:b.imdb)}"
              >${Z.ImdbSvg}</a
            >
          </div>
        </div>
        ...
        <div class="people">
          ...
          <ul class="people-list">
            ${(h=(n=this.people)==null?void 0:n.cast)==null?void 0:h.map(l=>{var V,L;return c`<li>
                  <person-card
                    person-name="${l.name}"
                    person-role="${l.character}"
                    person-image="${(V=l==null?void 0:l.images)!=null&&V.headshot[0]?`https://${(L=l==null?void 0:l.images)==null?void 0:L.headshot[0]}`:""}"
